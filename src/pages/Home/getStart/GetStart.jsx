    ...
    <div className="max-w-7xl mx-auto pb-[40px] mb:pb-[60px] lg:pb-[120px]">
      <div className="relative w-full px-4 py-8 md:px-0 bg-gray-950 rounded-xl">
        ...
        <div className="relative z-10 max-w-3xl py-[15px] mb:py-[30px] mx-auto text-white">
          <h1 className='text-[22px] md:text-3xl lg:text-5xl font-bold md:text-center md:leading-[50px]'>
            Bring Your Ideas Alive
          </h1>
          <p className='max-w-2xl pb-[20px] md:pb-[40px] pt-[10px] md:pt-[20px] mx-auto text-lg md:text-xl text-center'>
