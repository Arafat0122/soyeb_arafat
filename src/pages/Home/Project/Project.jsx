...
const Project = ({ limit }) => {
  const projects = [
    ...
    },
    {
      ...
      description:
        "Quranic Ilm is a responsive website for a Quran teaching academy. The platform provides basic information about the academy, its courses, and teachers. Designed with a clean and accessible layout, it ensures an easy user experience for students and parents looking to enroll.",
      coreFeatures: [
      ...
      <MotionWrapper direction="up" delay={0.1}>
        <div className="flex flex-col md:flex-row gap-4 md:gap-12 mb-[20px] md:mb-[80px]">
          ...
          <p className="text-base md:text-xl text-gray-700 md:w-[90%]">
            ...
            in full-stack development, modern UI design, and scalable web
            solutions. Each project reflects my focus on performance, user
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70">
          <div className="relative w-full max-w-6xl p-6 bg-white rounded-2xl shadow-xl dark:bg-gray-900 overflow-y-auto h-[500px]  lg:max-h-[90vh]">
            <button
              ...
              className="absolute p-1 text-xl text-red-600 rounded-full top-3 right-3 dark:text-gray-300 hover:bg-red-500 hover:text-white"
            >
              <X />
            </button>
