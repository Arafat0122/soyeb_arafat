...
const Education = () => {
    return (
        <div>
            <h2 className="mb-8 text-3xl font-bold text-center md:text-4xl lg:text-5xl font-monster">My Education</h2>
                    ...
                    <div className="grid gap-4 mx-4 sm:grid-cols-12">
                        <div className="col-span-12 sm:col-span-3">
                            <div className="text-center sm:text-left mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:bg-red-600">
                                ...
                                <span className="text-sm font-bold tracking-wider text-gray-600 uppercase">My Academic Journey</span>
                            </div>
                        </div>
                            ...
                            <div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-gray-300">
                                {educationData.map((edu, index) => (
                                    ...
                                    >
                                        ...
                                        <time className="text-xs tracking-wide text-gray-600 uppercase">{edu.duration}</time>
