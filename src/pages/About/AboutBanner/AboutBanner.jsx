...
const AboutBanner = () => {
  return (
    <section className="relative w-full px-4 py-8 md:px-0 bg-gray-950 pt-[100px] lg:h-[700px] rounded-b-2xl mb-12 lg:rounded-b-[60px]">
      ...
      <div className="relative z-10 text-white ">
        <div className="relative flex flex-col items-center justify-end h-full gap-4 mx-auto ">
          <img
            ...
            alt="Hero"
            className="h-auto -mb-[30px] lg:h-[600px]"
          />
          <h2 className="absolute text-[40px] font-bold text-white  top-[10%] uppercase left-[20%] hidden 2xl:block">
            Empowering <br /> Ideas With <br /> Code
          </h2>
          <div className="absolute max-w-xl mt-2 top-[10%] right-[5%] hidden 2xl:block">
